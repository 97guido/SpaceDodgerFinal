...
var steelTextures, rockTexture, skyTexture;
function setTextures() {
	skyTexture = textureFromImage("resources/data/Universe/Sky2.jpg");
	rockTexture = textureFromImage("resources/data/Asteroidi/rock.jpg");
	rockTexture2 = textureFromImage("resources/data/Asteroidi/Rock026_1K-JPG/Rock026_1K_Color.jpg");
	bluFireTexture = textureFromImage("resources/data/Astronave/Lava004_1K-JPG/Lava004_1K_Color.jpg");
	steelTexture = textureFromImage("resources/data/Astronave/Steel.jpg");
	corniceTexture = textureFromImage("resources/data/Astronave/cornice.jpg");
}
